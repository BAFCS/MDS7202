...
with gr.Blocks(theme=gr.themes.Soft()) as demo:
    ...
    with gr.Row():  # Generamos una fila
        with gr.Column():
            ...
            categoria_Problema = gr.Dropdown(
                ...
                choices=["Cuenta", "Fraude", "Técnica", "Pregunta general", "Cobros", "Otro"],
                value="Cuenta",
                interactive=True,
            )
        ...
        with gr.Column():
            ...
            Usuario_Tipo_de_Cuenta = gr.Dropdown(
                label="Tipo de cuenta del usuario",
                choices=["Free", "Premium", "Business"],
                value="Free",
                interactive=True,
            )
            Usuario_Antiguedad_Cuenta_Dias = gr.Number(
                label="Días de antiguedad del usuario", precision=0
    ...
    boton_predecir.click(
        ...
        inputs=[
            ...
            canal,
            categoria_Problema,
            Usuario_Tipo_de_Cuenta,
            Usuario_Antiguedad_Cuenta_Dias,
        ],
        outputs=[id_salida, resultado_prioridad],
    )
